...
import com.agriguid.service.UserService;
...
public class UserController {
    ...
    @GetMapping("/verified-farmers")
    public ResponseEntity<List<User>> getVerifiedFarmers() {
        return ResponseEntity.ok(userService.getVerifiedFarmers());
    }
